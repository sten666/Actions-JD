...
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "kb6dfwffm5de3qsppipq5imwoe",
    nc: $.getdata("nc_shareCode1") || "922bd755c6e24857a67167559e3ff2f4",
    mc: $.getdata("mc_shareCode1") || "MTAxODc2NTEzMjAwMDAwMDAzMjUxNjIxMQ==",
    ddgc: $.getdata("dd_shareCode1") || "P04z54XCjVWnYaS5nRRWT6mhg",
  ...
  
  {
    ...
    mc: $.getdata("mc_shareCode2") || "MTE1NDUwMTI0MDAwMDAwMDM1MjA0MzIx",
  ...
  },
  {
    ...
    nc: $.getdata("nc_shareCode3") || "d72fc4a73a774febb53a22394c7ea178",
    mc: $.getdata("mc_shareCode3") || "MTE1NDAxNzcwMDAwMDAwMzYwODI1OTc=",
    ddgc: $.getdata("dd_shareCode3") || "",
    jxgc: $.getdata("jx_shareCode3") || "",
    jxzz: $.getdata("jx_zzshareCode3") || "AUWE5387qj217TQeemyYj",
    crazyjoy: $.getdata("jd_joyshareCode3") || "t1SQQC-EfWQU3AEZE1XEAA==",
  },
];
$.result = [];
